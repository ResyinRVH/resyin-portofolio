  ...
  return (
    <>
      <section id="skill" className="pt-20 px-5">
        <div className="w-full h-85 px-8 py-8 bg-linear-to-r from-[#276F27] via-[#8ECA3C] to-[#BBDC12] shadow-xl/10 rounded-4xl text-left dark:bg-linear-to-r dark:from-[#1E1E1E]/30 dark:via-[#1E1E1E]/10 dark:to-[#1E1E1E]/0">
